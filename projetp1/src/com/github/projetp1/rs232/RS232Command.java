...
public class RS232Command
{
	 ...
	 * 
	 * @param chain
	 *            The original string, as received by RS-232
	 * @throws CrcException
	 *             Thrown if the CRC is faulty
	 * @throws IllegalArgumentException
	 *             Can be thrown when the String does not conform with the standards.
	 */
	 ...
	 * 
	 * @param chain
	 *            The String that was received via RS-232
